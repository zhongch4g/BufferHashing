#ifndef CCEH_BUFLOG_WAL_H_
#define CCEH_BUFLOG_WAL_H_
...
struct Segment {
    ...
    void initSegment (size_t depth) {
        ...
        // logPtr = pmem::obj::make_persistent<::LogPtr> ();
        logPtr.initLogPtr ();
        //  ->initLogPtr ();
        // logPtr.persist ();
        local_depth = depth;
    ...
    struct Segment *SplitDram (PMEMobjpool *, WriteBuffer::Iterator &iter);
    ...
    int64_t sema = 0;
    size_t local_depth;
    // pmem::obj::persistent_ptr<::LogPtr> logPtr;
    buflog_recovery::LogPtr logPtr;
};
...
public:
    ...
    void initCCEH (PMEMobjpool *, size_t, size_t, PMEMoid *);
    ...
    // pmem::obj::persistent_ptr<buflog_recovery::linkedredolog::BufferLogNode[]> BufferLogNodes;
