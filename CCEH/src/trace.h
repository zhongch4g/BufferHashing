...
#define FNV_PRIME_64 ((UINT64_C (1099511628211)))
    explicit TraceExponential (int seed, const double percentile = 50,
                               double range = kRANDOM_RANGE);
    ~TraceExponential () {}
    uint64_t Next () override;
...
#define FNV_OFFSET_BASIS_64 ((UINT64_C (0xCBF29CE484222325)))
#define FNV_PRIME_64 ((UINT64_C (1099511628211)))
    explicit TraceExponentialReverse (int seed, const double percentile = 50, double offset = 0,
                                      double range = kRANDOM_RANGE);
