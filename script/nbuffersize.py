...
BH_R = []
BH_W = []
with open("../release/bh_buffer_size_20.data", "r") as f:
...
percentage = ["1KB", "2KB", "4KB", "8KB", "16KB"]
...
ax.set_ylim([0.1, max(BH_Write_Th)*1.25])
...
fig.savefig("evaluation/bh_with_buffer_size.pdf", bbox_inches='tight', pad_inches=0)