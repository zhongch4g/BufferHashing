...
using namespace cceh_buflog_wal;
...
public:
    ...
    void DoRecovery (ThreadState* thread) {
        ...
        // hashtable_->BufferRecovery2 (pop_, FLAGS_thread, thread->tid);
    ...
    void DoLoadFactor (ThreadState* thread) {
        ...
        while (key_iterator.Valid ()) {
            ...
            printf ("Load factor: %.3f\n",
                    (double)(InsertWithLoged) / D_RW (hashtable_)->Capacity ());
        }
        return;
    }
