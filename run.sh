...
# sudo numactl -N 0 ./cceh_limit_bench --thread=16 --benchmarks=load --num=120000000 --bufferNum=70000

# Set the insnum in case that you need run more instances at the same time
######################################## CCEH-BUFLOG-LIMIT #######################################
